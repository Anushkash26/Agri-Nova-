        ...
        <div className="w-full max-w-md">
          <Card className="border-green-100 shadow-lg">
            <CardHeader className="space-y-1">
              <CardTitle className="text-2xl font-bold text-center text-green-800">Welcome to Agri-nova</CardTitle>
              <CardDescription className="text-center">
                Connect with farmers, buyers, and agricultural service providers
              </CardDescription>
            </CardHeader>
            <CardContent>
